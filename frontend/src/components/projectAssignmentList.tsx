...
const ProjectAsignmentList: NextPage = () => {
    ...
    useEffect(() => {
        async function fetchProjects() {
            ...
            await Promise.all(response._embedded.projects.map(async (project) => {
                const assignments: IAssignmentPage = (await axios.get(project._links.assignments.href, AxiosConf)).data;
