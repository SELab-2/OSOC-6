...
describe("InvitationButton", () => {
    ...
    it("click", async () => {
        render(
            makeCacheFree(InvitationButton)
        );
        ...
        mockAxios.mockResponseFor(apiPaths.editions, getBaseOkResponse(
            getBasePage(apiPaths.editions, editionCollectionName, [baseEdition])
        ));
